...
do
    python main/evaluate.py --data_dir data/imagenet/ --arch resnet_50 --job_dir result/resnet_50/vbd_dis --epochs 180 --lr_type cos --momentum 0.99 --use_pretrain --pretrain_dir checkpoint/imagenet/resnet_50.pth --criterion VBD_dis --strategy min_sum --compress_rate $cpr --weight_decay 0.0001 --batch_size 256 --rank_conv_prefix rank
done
